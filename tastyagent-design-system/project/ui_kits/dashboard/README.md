# IBTastyAgent — Dashboard UI Kit

A high-fidelity, interactive recreation of the **IBTastyAgent control panel** — the single
surface the operator uses to _monitor_ and _manage_ the agent. Built to the brand & IA in
